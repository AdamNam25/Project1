              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($post->photo)
                            @php
                                $postPhoto = Helper::imageUrl($post->photo);
                                if (empty($postPhoto)) {
                                    $postPhoto = 'https://via.placeholder.com/80x80?text=Post';
                                }
                            @endphp
                            <img src="{{ $postPhoto }}" class="img-fluid zoom" style="max-width:80px" alt="{{$post->title}}">
                        @else
