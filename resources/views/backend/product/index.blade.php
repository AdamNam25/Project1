                    ...
                    <td>
                        @if($product->photo)
                            @php
                                ...
                                $primaryPhoto = Helper::imageUrl($photoList[0] ?? null) ?? 'https://via.placeholder.com/80x80?text=No+Image';
                            @endphp
                            <img src="{{ $primaryPhoto }}" class="img-fluid zoom" style="max-width:80px" alt="{{$product->title}}">
                        @else
