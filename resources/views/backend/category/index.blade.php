              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                            @php
                                $categoryPhoto = Helper::imageUrl($category->photo) ?? 'https://via.placeholder.com/80x80?text=Category';
                            @endphp
                            <img src="{{ $categoryPhoto }}" class="img-fluid" style="max-width:80px" alt="{{$category->title}}">
                        @else
