...
@section('title','Arvila || Chi Tiết Bài Viết')
                            ...
                            <div class="col-12">
                                <div class="image">
                                    @php
                                        ...
                                        if (empty($postImage)) {
                                            $postImage = 'https://via.placeholder.com/800x600?text=No+Image';
                                        }
                                    @endphp
                        ...
                        <div class="single-widget recent-post">
                            ...
                            @foreach($recent_posts as $post)
                                ...
                                <div class="single-post">
                                    <div class="image">
                                        @php
                                            $recentPostImage = Helper::imageUrl($post->photo);
                                            if (empty($recentPostImage)) {
                                                $recentPostImage = 'https://via.placeholder.com/300x200?text=No+Image';
                                            }
                                        @endphp
                                        <img src="{{ $recentPostImage }}" alt="{{$post->title}}">
                                    </div>
                                    <div class="content">
