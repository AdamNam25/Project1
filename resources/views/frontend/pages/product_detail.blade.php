...
@section('meta')
	...
	<meta property="og:image" content="{{ Helper::imageUrl($product_detail->photo) }}">
	<meta property="og:description" content="{{$product_detail->description}}">
@endsection
@section('title','Arvila || Chi Tiết Sản Phẩm')
									...
									<div class="col-lg-6 col-12">
										...
										<div class="product-gallery">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
													@php
														$photoList = array_filter(explode(',',$product_detail->photo));
													@endphp
													@foreach($photoList as $data)
														@php
															$imageUrl = Helper::imageUrl($data) ?? 'https://via.placeholder.com/800x800?text=No+Image';
														@endphp
														<li data-thumb="{{ $imageUrl }}" rel="adjustX:10, adjustY:">
															<img src="{{ $imageUrl }}" alt="{{$product_detail->title}}">
														</li>
													@endforeach
												</ul>
											</div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
											@php
												$photoList = array_filter(explode(',',$data->photo));
												$primaryPhoto = Helper::imageUrl($photoList[0] ?? null) ?? 'https://via.placeholder.com/400x400?text=No+Image';
											@endphp
                                            <img class="default-img" src="{{ $primaryPhoto }}" alt="{{$data->title}}">
                                            <img class="hover-img" src="{{ $primaryPhoto }}" alt="{{$data->title}}">
